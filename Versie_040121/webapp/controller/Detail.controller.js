sap.ui.define([
	...
	"../model/formatter",
	"sap/m/library"
], function (Fragment, BaseController, JSONModel, formatter, mobileLibrary) {
	"use strict";
	...
	return BaseController.extend("ap.be.Eindwerk_MathiasV.controller.Detail", {
        ...
        handleEditPress : function () {
			...
			//Clone the data
            this._oProduct = Object.assign({}, this.getView().getModel().getData().ProductSet[0]);
		...
		handleCancelPress : function () {
			...
			oData.ProductSet[0] = this._oProduct;
