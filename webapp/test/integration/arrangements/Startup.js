sap.ui.define([
	"sap/ui/test/Opa5",
	"ap/be/Eindwerk_MathiasV/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("ap.be.Eindwerk_MathiasV.test.integration.arrangements.Startup", {
